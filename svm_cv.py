#!/usr/bin/env python3
"""
Support Vector Machine (SVM, RBF) with 10-fold Stratified CV + SMOTE-Tomek (k=5), reporting Accuracy, Precision (macro), Recall (macro), F1 (macro).

Usage:
  python svm_cv.py --data path/to/data.csv --target TARGET_COLUMN
...
def build_model():
    ...
    clf = SVC(kernel='rbf', C=1.0, gamma='scale', tol=1e-3, random_state=42)
    return clf
...
def main():
    ...
    print("===== Support Vector Machine (SVM, RBF) (10-fold CV) =====")
