#!/usr/bin/env python3
"""
Random Forest (RF) with 10-fold Stratified CV + SMOTE-Tomek (k=5), reporting Accuracy, Precision (macro), Recall (macro), F1 (macro).

Usage:
  python rf_cv.py --data path/to/data.csv --target TARGET_COLUMN
...
def build_model():
    ...
    clf = RandomForestClassifier(n_estimators=100, criterion='gini', max_depth=None, min_samples_split=2, random_state=42, n_jobs=-1)
    return clf
...
def main():
    ...
    print("===== Random Forest (RF) (10-fold CV) =====")
